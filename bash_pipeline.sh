...
sed -i -e 's/# Cluster Mean: //g' elki_output/$filename/$filename-k$k-samp1000/elki-clusters.txt; rm elki_output/$filename/$filename-k$k-samp$samp_size/elki-clusters.txt-e
